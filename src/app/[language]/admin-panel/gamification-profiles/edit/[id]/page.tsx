...
import EditGamificationProfile from "./page-content";
...
const NAMESPACES = ["admin-panel-gamification-profiles-edit"];

export async function generateMetadata(props: Props): Promise<Metadata> {
  const params = await props.params;
  const { t } = await getServerTranslation(
    params.language,
    "admin-panel-gamification-profiles-edit"
  );
